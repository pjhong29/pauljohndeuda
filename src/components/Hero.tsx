        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-12">
          <div className="md:w-1/2 relative">
            ...
            <img
              ...
              alt="Profile"
              className="relative z-10 w-72 h-72 object-cover rounded-2xl"
            />
          </div>
          <div className="animate-fade-in md:w-1/2">
            <span className="text-primary mb-4 inline-block">Hello Everyone</span>
            <h1 className="text-5xl md:text-7xl font-bold mb-6">
              Hi, I'm <span className="text-primary">Percian Joseph</span>
            </h1>
            ...
            <div className="text-lg md:text-xl text-gray-400 max-w-2xl mb-12">
              <p>
